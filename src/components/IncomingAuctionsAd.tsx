  ...
  return (
    <section className="flex flex-col md:flex-row w-full h-auto md:h-[515px]">
      ...
      <div className="w-full md:w-[30%] h-[250px] md:h-full">
        <img src={carsHomeImage2} alt="carshome2" className="w-full h-full object-cover" />
      </div>

      {/* Sección del contenido */}
      <div className="bg-[#0056B3] w-full text-white flex flex-col justify-center items-center p-6 lg:p-0">
